                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('etemporarytax.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        {{ Form::model($model, [
                            ...
                            'route' => $model->exists ? ['etemporarytax.update', 'id' => $model->id] : 'etemporarytax.store',
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Hari ke-') }}</label>
                                    {{ Form::number('day_n', null, ['class' => 'form-control form-control-alternative', 'required']) }}
                                </div>
